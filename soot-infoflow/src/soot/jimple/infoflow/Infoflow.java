...
public class Infoflow extends AbstractInfoflow {
     ...
     * files.
     *
     * @param androidPath     If forceAndroidJar is false, this is the base directory of the
     *                        platform files in the Android SDK. If forceAndroidJar is true,
     *                        this is the full path of a single android.jar file.
     * @param forceAndroidJar True if a single platform JAR file shall be forced, false if
...
//		runAnalysis(sourcesSinks, null);
     ...
     *
     * @param sourcesSinks    The sources and sinks to be used
     * @param additionalSeeds Additional seeds at which to create A ZERO fact even if they
     *                        are not sources
     */
...
//			results.addException(ex.getClass().getName() + ": " + ex.getMessage());
     ...
     *
     * @param propagationResults A reference to the result object of the forward data flow
     *                           solver
     * @param builder            The path builder to use for reconstructing the taint
     *                           propagation paths
     */
     ...
     * @param memoryManager The memory manager for rducing the memory load during IFDS
     *                      propagation
     ...
     * @param allowSetSemantics True if the executor shall have thread semantics, i.e., never
     ...
     *
     * @param sourcesSinks   The SourceSinkManager to be used for identifying sources and
     *                       sinks
