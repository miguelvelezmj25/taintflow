...
//        infoflow.computeInfoflow(AnalysisTest.appPath, AnalysisTest.libPath, entryPoints, infoflow.getSources(), infoflow.getSinks());
    ...
    @Test
    public void Graph0() throws IOException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        File file = new File("/Users/mvelezce/Documents/Programming/Java/Projects/performance-mapper-evaluation/instrumented/dummy/out/production/dummy");
        AnalysisTest.appPath = file + AnalysisTest.sep + AnalysisTest.appPath;

        String systemName = "graph0";
        TaintInfoflow infoflow = new TaintInfoflow(systemName);
...
//        infoflow.setTaintWrapper(easyWrapper);
        ...
        // Add entry points
        String entryPoint = "<edu.cmu.cs.mvelezce.Graph0: void main(java.lang.String[])>";
